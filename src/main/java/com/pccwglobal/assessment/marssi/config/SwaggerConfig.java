package com.pccwglobal.assessment.marssi.config;

//import com.fasterxml.classmate.TypeResolver;
//import com.pccwglobal.assessment.marssi.exception.ErrorMessage;
...
public class SwaggerConfig {
    ...
    public Docket petApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.pccwglobal.assessment.marssi.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("Mars Si", "#", "seithew.si@gmail.com"))
                .version("1.0")
                .build();
    }
